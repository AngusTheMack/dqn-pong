...
This lab explores the implementation of a Deep Q-Learning (DQN) agent to play pong through the use of OpenAI \cite{openai}. Initial course provided source code acted as the base, and then a solution was built on top to the specification of \cite{Deepmind} and \cite{NaturePaper}.
