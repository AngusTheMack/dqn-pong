...
\section{Method}
A model was created in order to train the DQN, this model used the same architecture as that of \cite{NaturePaper}. This network takes in an input of 4 frames as the state representation, and then has an output for each possible action. 
